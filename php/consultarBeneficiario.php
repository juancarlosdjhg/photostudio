			...
			<tr>
				<td>
					<ul id="tabs">
   					...
   					<span><input type="submit" class="submit" name="consultaremp" value="CONSULTAR"></span>
					    ...
					    <div id="tab2">
						    ...
						    <span><label>DATOS DE TODOS LOS EMPLEADOS</label></span>
						     <span style="width:620px; height: 300px; overflow: auto; padding: 5px">  
						...
						<td>
							...
							<td>
							<form action='centroBeneficiario.php' method='post'>
							<input type='hidden' name='cedula' value='$data[cedula]'>
						<input type='submit' name='consultaremp' value='VER' />				
						</form>
						</td>
